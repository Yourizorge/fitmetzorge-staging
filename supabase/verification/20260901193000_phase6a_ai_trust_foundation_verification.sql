...
expected_tables(table_schema, table_name, columns) as (
  values
    ('public','ai_consent_events',array['id:uuid','user_id:uuid','consent_kind:text','consent_state:text','document_version:text','purpose_code:text','categories:_text','locale:text','explicit_confirmation:bool','request_id:uuid','created_at:timestamptz']::text[]),
