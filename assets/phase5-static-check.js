...
const files = {
  ...
  migration: fs.readFileSync(path.join(root, "supabase/migrations/20260831145357_phase5_progress_foundation.sql"), "utf8"),
  units: fs.readFileSync(path.join(root, "supabase/migrations/20260831150434_phase5_progress_unit_preference.sql"), "utf8"),
  revisionIndexes: fs.readFileSync(path.join(root, "supabase/migrations/20260831153512_phase5_progress_revision_indexes.sql"), "utf8"),
  unitConstraintFix: fs.readFileSync(path.join(root, "supabase/migrations/20260901161314_phase5_unit_system_constraint_fix.sql"), "utf8"),
...
check("Phase 1 cache version", files.app.includes('assets/phase1-foundation.js?v=20260904-auth-lifecycle2'));
check("app cache version", files.app.includes('assets/phase5-progress.js?v=20260904-auth-lifecycle2'));
