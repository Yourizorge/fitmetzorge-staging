...
async function runViewport(browser, width, height) {
  ...
  const harness = `
    ...
    window.__consent={contracts:[{consent_kind:"private_chat",document_version:"phase6d-private-chat-v1",content_text:"Ik begrijp dat mijn gegevens in deze beveiligde stagingtest worden verwerkt."}],current:{private_chat:{consent_state:"granted"}}};
