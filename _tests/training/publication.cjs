...
const mobileBaseline="633e9f9ab50bd298a66088e6cc0cb824215e98f5";
const mobileChanges=["app.js","index.html","assets/phase3-training-engine.js","assets/training-workout-ui.js","assets/training-workout.css","assets/vendor/lucide-clock.svg"];
...
(async()=>{
 ...
 fs.writeFileSync(path.join(root,"supabase/.temp/training-mobile-publication.json"),JSON.stringify(result,null,2));
