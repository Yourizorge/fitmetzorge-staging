(async () => {
  ...
  const phase1PatchUrl = new URL("assets/phase1-foundation.js?v=20260818-member-ux-runtime-contract1", document.baseURI);
  ...
  const memberUxPatchUrl = new URL("assets/member-ux-consistency.js?v=20260818-member-ux-runtime-contract1", document.baseURI);
