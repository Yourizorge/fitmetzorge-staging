...
fs.writeFileSync(path.join(root,"supabase/.temp/phase6e9-tests.json"),JSON.stringify(out,null,2)+"\n");
assert(Object.values(results).every(x=>x.exit===0));assert.equal(out.counts.skipped,0);console.log(JSON.stringify(out.counts));
