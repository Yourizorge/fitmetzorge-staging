...
Status: FOUNDATION LIVE / VERIFIED ON STAGING; NORMALIZATION-CORRECTED 24,458-PRODUCT IMPORT ARTIFACT BUILT / LOCALLY VERIFIED; OFF IMPORT NOT STARTED

Summary: The owner-approved architecture keeps Open Food Facts in three separate ODbL tables and never merges it into `public.foods`. Migration `20260824113551` is live on staging and the corrected foundation verifier returned `overall_pass = true`, 26 PASS and 0 FAIL. The three OFF tables, typed bounded unified search, exact local barcode lookup, GTIN normalization, RLS, policies, and column-scoped ACLs are present and still empty. The pinned source pipeline reproduces 106,650 Netherlands-associated rows and exactly 24,458 eligible branded products. The corrected generator now mirrors the existing PostgreSQL `public.fmz_phase4_normalize_catalog_text(text)` contract exactly, without Unicode compatibility normalization or transliteration. The correction affects one product row, one normalized brand and 23 name rows/name UUIDs; all 24,458 product UUIDs remain unchanged. The deterministic bundle passes 779,905 artifact checks, 93 static/security checks, 13 live/local normalization-contract checks, and a schema-equivalent PostgreSQL rollback/import/verifier/replay dry run. It has not been executed on staging. No frontend or Edge deployment occurred.

Artifacts: migration SHA-256 unchanged at `606658F53EA29083E315F43546B507B40C9D0CF7D02FB074591B542E71D89AF4`; corrected foundation verifier SHA-256 `7E5D6CB7859A5BEE733E379ABAD5661FE08FBF680AC984F4D80C5F109B4DECD2`. Corrected bulk hashes: release `06A53E9266160767828E1576F982C07CA90D8E74DEA3B20A9096B56507F21F88`; products `BFB88DFC6C57E2EC4EDA05E29C5F19515E678B7509C0EC4D62BD9686C57F6A9D`; names `04E56D0D237CABB77DE2A574D8CEC4A440C15D6824645820920CCB4B220FFAC6`; manifest `473BDAA8E8611F39C3D20E366FEEF6FD5B165456F50DCFFBEDBFA5EA7B272BAC`; importer `9EEDC73E03FEDCA5ACF8FDFF2A3F77459C1589C710B903C12DFFB7E33EBAE506`; post-import verifier `AC0BB83EB1140DCA69468C65832F57C694A833AA3A8E82536A6F4419FC2F902D`; normalization verifier `44F18C290E1C5E76DF270F500B814E0A55CE218860F784337256791780F4F0AF`. All preceding bulk-artifact hashes are invalidated. The NL display-label runtime fix remains local and undeployed.
