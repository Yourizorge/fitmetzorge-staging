...
Status: FOUNDATION LIVE / VERIFIED ON STAGING; 24,458-PRODUCT IMPORT ARTIFACT BUILT / LOCALLY VERIFIED; OFF IMPORT NOT STARTED

Summary: The owner-approved architecture keeps Open Food Facts in three separate ODbL tables and never merges it into `public.foods`. Migration `20260824113551` is live on staging and the corrected foundation verifier returned `overall_pass = true`, 26 PASS and 0 FAIL. The three OFF tables, typed bounded unified search, exact local barcode lookup, GTIN normalization, RLS, policies, and column-scoped ACLs are present and still empty. The pinned source pipeline reproduces 106,650 Netherlands-associated rows and exactly 24,458 eligible branded products. Its deterministic ODbL release/product/name/import/verifier bundle is built and locally verified with 755,433 row/data-quality checks and 75 static/security checks; it has not been executed. No frontend or Edge deployment occurred.

Artifacts: migration SHA-256 unchanged at `606658F53EA29083E315F43546B507B40C9D0CF7D02FB074591B542E71D89AF4`; corrected foundation verifier SHA-256 `7E5D6CB7859A5BEE733E379ABAD5661FE08FBF680AC984F4D80C5F109B4DECD2`; prior verifier SHA-256 `4772BF4550978572BE6DD0D595A42E145FB2DF7D29D7008FF3F87934A12F967D` invalidated. Slice 4F foundation/static/security suite PASS, 127 checks. Bulk product/name CSV hashes are `BA0AD94F...13E1ABF` and `AE2336D0...8A0132`; importer hash `3927F0F0...5801CC`; post-import verifier hash `A502967B...C1B12`. The NL display-label runtime fix remains local and undeployed.
